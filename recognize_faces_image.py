...
# python recognize_faces_image.py --encodings faces1.pickle --image examples/p1.jpg 
# python recognize_faces_image.py --encodings faces1.pickle --image examples/a.JPEG
